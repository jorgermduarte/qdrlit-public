...
class DatabaseEnvironment(gym.Env):
    ...
    def step(self, action):
        ...
        power_queries_exec_time_sum_sec, power_refresh_function_exec_time_sum_sec, throughput_total_exec_time_sec = self._db.get_benchmark_exec_times()

        return (self._get_observation(),  # Observation
                reward,  # Reward
                False,  # is Episode done
                {
                    'initial_state_reward': self._initial_state_reward,
                    'benchmark_metrics_raw_data': self._db.get_benchmark_metrics_raw_data(),
                    'power_queries_exec_time_sum_sec': power_queries_exec_time_sum_sec,
                    'power_refresh_function_exec_time_sum_sec': power_refresh_function_exec_time_sum_sec,
                    'throughput_total_exec_time_sec': throughput_total_exec_time_sec  
                })  # Additional info
