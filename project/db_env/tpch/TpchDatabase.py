...
class TpchDatabase(Database):
    ...
    def get_benchmark_exec_times(self) -> Tuple[float, float, float]:
        return self._benchmark.get_execution_times()
    
    def get_benchmark_metrics_raw_data(self) -> Dict:
        return self._benchmark.get_benchmark_metrics_raw_data()
